...
migrate((app) => {
  const snapshot = [
    ...
    },
    {
      ...
      "system": false,
      "type": "auth",
      "updateRule": "@request.auth.id = id && @request.body.Paid:isset = false && @request.body.First_Name:isset = false && @request.body.Last_Name:isset = false && @request.body.Category:isset = false && @request.body.email:isset = false && @request.body.School:isset = false && @request.body.Phone_Number:isset = false",
    ...
    },
    {
      ...
      "deleteRule": "@request.auth.id = Admin.id",
      "fields": [
        {
          "autogeneratePattern": "[a-z0-9]{15}",
          "hidden": false,
    ...
    {
      "createRule": "@request.auth.id = Group.Admin.id",
      "deleteRule": "@request.auth.id = Participant.id",
      "fields": [
        {
          "autogeneratePattern": "[a-z0-9]{15}",
          "hidden": false,
    ...
    {
      "createRule": "@request.auth.id = Participant.id",
      "deleteRule": "@request.auth.id = Participant.id",
      "fields": [
        {
          "autogeneratePattern": "[a-z0-9]{15}",
      ...
      "listRule": "@request.auth.id = Participant.id",
      "name": "Solo_Segment_Participant",
      "system": false,
      "type": "base",
      "updateRule": null,
      "viewRule": "@request.auth.id = Participant.id"
    },
    {
      "createRule": "@request.auth.id = Group.Admin.id && @request.body.Submission:isset = false",
      "deleteRule": "@request.auth.id = Group.Admin.id",
      "fields": [
        {
          "autogeneratePattern": "[a-z0-9]{15}",
          "hidden": false,
      ...
      "system": false,
      "type": "base",
      "updateRule": "@request.auth.id = Group.Admin.id",
      "viewRule": "@request.auth.verified = true"
    },
    {
      "createRule": "",
